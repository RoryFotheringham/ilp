...
public class PathFindTest {
    ...
    public void findPathPathListTest() {
        Path path = PathFind.findPath(testGraph, testNodes.get(0), testNodes.get(7), null, null, null);
    ...
    public void findPathDistanceTest(){
        Path path = PathFind.findPath(testGraph, testNodes.get(1), testNodes.get(5), null, null, null);
    ...
    public void findPathSingletonPathTest(){
        Path path = PathFind.findPath(testGraph, testNodes.get(3), testNodes.get(3), null, null, null);
    ...
    public void findPathTuplePathTest(){
        Path path = PathFind.findPath(testGraph, testNodes.get(2), testNodes.get(3), null, null, null);
        ArrayList<Node> expected = new ArrayList<Node>();
